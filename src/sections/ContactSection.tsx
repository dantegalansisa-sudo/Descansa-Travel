...
export default function ContactSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const text = `Hola! Solicito cotización:\n- Nombre: ${form.nombre}\n- Teléfono: ${form.telefono}\n- Destino: ${form.destino}\n- Servicio: ${form.servicio}\n- Fecha: ${form.fecha}\n- Viajeros: ${form.viajeros}\n- Mensaje: ${form.mensaje}`;
    window.open(`https://wa.me/18296640750?text=${encodeURIComponent(text)}`, '_blank');
  };
            ...
            <div className="contact__details">
              <div className="contact__detail">
                ...
                <div>
                  ...
                  <a href="https://wa.me/18296640750" target="_blank" rel="noopener noreferrer">829-664-0750</a>
                </div>
              </div>
              <div className="contact__detail">
                <span className="contact__detail-icon">📍</span>
              ...
              <div className="contact__detail">
                ...
                <div>
                  ...
                  <a href="https://instagram.com/descansatravelrd" target="_blank" rel="noopener noreferrer">@descansatravelrd</a>
                </div>
              </div>
            </div>
