...
const features = [
  ...
  { icon: '🏆', title: 'Agencia Registrada', desc: 'Agencia de viajes registrada en República Dominicana.' },
          ...
          <div className="whyus__left">
            ...
            >
              ...
              <div className="whyus__image-badge">
                <img src="/imagenes/logo.png" alt="Descansa Travel" className="whyus__badge-logo" />
                <div>
                  <strong>Descansa Travel</strong>
