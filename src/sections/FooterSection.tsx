        ...
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            <div className="footer__logo-row">
              <img src="/imagenes/logo.png" alt="Descansa Travel" className="footer__logo" />
            </div>
            ...
            <div className="footer__social">
              <MagneticButton
                href="https://instagram.com/descansatravelrd"
          ...
          <div className="footer__col">
            ...
            <ul className="footer__links">
              {destLinks.map((d) => (
                <li key={d}>
                  <a href={`https://wa.me/18296640750?text=${encodeURIComponent(`Hola! Me interesa volar a ${d}`)}`} target="_blank" rel="noopener noreferrer">{d}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="footer__col">
            ...
            <ul className="footer__links">
              <li><a href="https://wa.me/18296640750" target="_blank" rel="noopener noreferrer">829-664-0750</a></li>
              <li><span>Santo Domingo, República Dominicana</span></li>
            </ul>
          </div>
        </div>

        <div className="footer__cesdn">
          Agencia de viajes registrada en República Dominicana.
        </div>

        <div className="footer__bottom">
          <span>&copy; 2026 Descansa Travel. Todos los derechos reservados.</span>
